...
public class ProjectapplyService {
    ...
    public Map<String, Integer> getStatistics() {
        ...
        statistics.put("totalApplications", projectapplyMapper.getTotalApplications());
        statistics.put("pendingReviews", projectapplyMapper.getPendingReviews());
        statistics.put("monthlyApproved", projectapplyMapper.getMonthlyApproved());
        return statistics;
    }
