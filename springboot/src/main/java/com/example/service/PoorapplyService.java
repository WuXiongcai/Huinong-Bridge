...
public class PoorapplyService {
    ...
    public Map<String, Integer> getStatistics() {
        ...
        statistics.put("totalApplications", poorapplyMapper.countAllApplications());
        statistics.put("pendingReviews", poorapplyMapper.countPendingApplications());
        statistics.put("monthlyApproved", poorapplyMapper.countMonthlyApprovedApplications());
