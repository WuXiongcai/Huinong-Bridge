...
public class OrdersService {
    ...
    public Map<String, Object> getStatistics() {
        ...
        statistics.put("totalOrders", ordersMapper.getTotalOrders());
        statistics.put("pendingShipments", ordersMapper.getPendingShipments());
        statistics.put("monthlySales", ordersMapper.getMonthlySales());
        return statistics;
    }
