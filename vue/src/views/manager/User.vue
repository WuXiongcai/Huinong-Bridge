<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入账号查询" style="width: 200px" prefix-icon="el-icon-search" v-model="username"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="level" label="身份">
          <template v-slot="{ row }">
            <el-tag :type="row.level === '贫困户' ? 'danger' : 'success'">
              {{ row.level }}
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="180">
          <template v-slot="scope">
            ...
            <el-button size="mini" type="danger" plain icon="el-icon-delete" @click="del(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="新增用户" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
